...
export const translations = {
  en: {
    ...
    strategy_live_execution: "Live CLOB Execution",
    strategy_live_execution_desc: "Live orders are only sent when paper trading is off and the worker has Polymarket credentials.",
    strategy_live_execution_paper: "Paper trading is enabled, so live order submission is disabled.",
    strategy_live_execution_ready: "Paper trading is off. Live order submission is enabled in the bot config.",
    strategy_roda: "Resolution Lag Arb",
    strategy_roda_desc: "Resolution-lag arbitrage on unresolved markets.",
    strategy_roda_divergence: "RODA Divergence",
    strategy_roda_divergence_desc: "Cross-platform probability divergence arbitrage.",
    strategy_lch: "LCH",
    strategy_lch_desc: "Shock recovery and cascade reversal trades.",
    strategy_hybrid: "Hybrid",
    strategy_hybrid_desc: "Resolution Lag Arb + LCH-Cross capital allocator.",
    strategy_mss2: "MSS2",
    ...
    latency_title: "Latency profile",
    latency_signal_to_decision: "Signal → decision",
    latency_signal_to_trade: "Signal → trade",
    latency_signal_to_confirmation: "Signal → confirmation",
    latency_events: "Latency events",
    slo_title: "SLO health",
    slo_error_rate: "Error rate (24h)",
    slo_heartbeat: "Heartbeat age",
    slo_dropped_signals: "Dropped signals",
    slo_fill_success: "Fill success rate",
    slo_reconciliation_drift: "Reconciliation drift",
    slo_heartbeat_stale: "Stale",
    slo_heartbeat_fresh: "Fresh",
  ...
  ru: {
    ...
    strategy_live_execution: "Live CLOB исполнение",
    strategy_live_execution_desc: "Живые ордера отправляются только когда выключена бумажная торговля и у worker есть Polymarket credentials.",
    strategy_live_execution_paper: "Бумажная торговля включена, поэтому отправка live-ордеров отключена.",
    strategy_live_execution_ready: "Бумажная торговля выключена. Отправка live-ордеров включена в конфиге бота.",
    strategy_roda: "Арбитраж задержки резолюции",
    strategy_roda_desc: "Арбитраж на задержке резолюции по нерезолвленным рынкам.",
    strategy_roda_divergence: "RODA Divergence",
    strategy_roda_divergence_desc: "Арбитраж расхождений вероятностей между платформами.",
    strategy_lch: "LCH",
    strategy_lch_desc: "Сделки на восстановлении после шока и каскада.",
    strategy_hybrid: "Гибрид",
    strategy_hybrid_desc: "Аллокатор капитала для Арбитража задержки резолюции + LCH-Cross.",
    strategy_mss2: "MSS2",
    ...
    latency_title: "Профиль задержек",
    latency_signal_to_decision: "Сигнал → решение",
    latency_signal_to_trade: "Сигнал → сделка",
    latency_signal_to_confirmation: "Сигнал → подтверждение",
    latency_events: "События latency",
    slo_title: "SLO состояние",
    slo_error_rate: "Ошибки (24ч)",
    slo_heartbeat: "Возраст heartbeat",
    slo_dropped_signals: "Потерянные сигналы",
    slo_fill_success: "Успешность fill",
    slo_reconciliation_drift: "Отклонение сверки",
    slo_heartbeat_stale: "Старый",
    slo_heartbeat_fresh: "Свежий",
    ...
    strategy_max_drawdown: "Макс. просадка",
    strategy_sharpe: "Шарп",
    strategy_sortino: "Сортино",
