...
const SCHEMA_STATEMENTS = [
  ...
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS retention_scan_interval INTEGER NOT NULL DEFAULT 48`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS reconciliation_enabled BOOLEAN NOT NULL DEFAULT TRUE`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS reconciliation_warning_pct REAL NOT NULL DEFAULT 0.01`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS reconciliation_critical_pct REAL NOT NULL DEFAULT 0.03`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS reconciliation_warning_usd REAL NOT NULL DEFAULT 5.0`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS reconciliation_critical_usd REAL NOT NULL DEFAULT 25.0`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS auto_recalibration_enabled BOOLEAN NOT NULL DEFAULT FALSE`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS auto_recalibration_interval_seconds INTEGER NOT NULL DEFAULT 3600`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS auto_recalibration_window_days INTEGER NOT NULL DEFAULT 14`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS auto_recalibration_min_trades INTEGER NOT NULL DEFAULT 20`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS auto_recalibration_apply_changes BOOLEAN NOT NULL DEFAULT FALSE`,
  sql`ALTER TABLE bot_config ADD COLUMN IF NOT EXISTS auto_recalibration_max_adjustment_pct REAL NOT NULL DEFAULT 0.15`,
