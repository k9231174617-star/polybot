...
export const UpdateBotConfigBody = z.object({
  ...
  auto_recalibration_enabled: z.boolean().optional(),
  auto_recalibration_interval_seconds: z.number().int().optional(),
  auto_recalibration_window_days: z.number().int().optional(),
  auto_recalibration_min_trades: z.number().int().optional(),
  auto_recalibration_apply_changes: z.boolean().optional(),
  auto_recalibration_max_adjustment_pct: z.number().optional(),
...
export const GetBotConfigResponse = z.object({
  ...
  auto_recalibration_enabled: z.boolean(),
  auto_recalibration_interval_seconds: z.number().int(),
  auto_recalibration_window_days: z.number().int(),
  auto_recalibration_min_trades: z.number().int(),
  auto_recalibration_apply_changes: z.boolean(),
  auto_recalibration_max_adjustment_pct: z.number(),
