...
export const botConfigTable = pgTable("bot_config", {
  ...
  auto_recalibration_enabled: boolean("auto_recalibration_enabled").notNull().default(false),
  auto_recalibration_interval_seconds: integer("auto_recalibration_interval_seconds").notNull().default(3600),
  auto_recalibration_window_days: integer("auto_recalibration_window_days").notNull().default(14),
  auto_recalibration_min_trades: integer("auto_recalibration_min_trades").notNull().default(20),
  auto_recalibration_apply_changes: boolean("auto_recalibration_apply_changes").notNull().default(false),
  auto_recalibration_max_adjustment_pct: real("auto_recalibration_max_adjustment_pct").notNull().default(0.15),
